    ...
    def override(func, q, k, v, heads, mask=None, attn_precision=None,
        ...
        def dense():
            ...
            if dense_override is not None:
                # Compose with a workflow-selected backend such as Sage or
                # Comfy Kitchen. Both nodes use optimized_attention_override,
                # so simply replacing the value would otherwise make the
                # last-installed node win. The previous override receives
                # ComfyUI's original backend in the same form wrap_attn
